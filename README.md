...
As for the project's vision, the thing I like about Explore Toronto is that it can be a variety of things, and serve a variety of purposes. It can serve as a a hub for small businesses in Toronto to promote their locations and businesses, It can be a social space where users rate their favourite spots in Toronto, or it can be as simple as a tracker for cool places you've visited in Toronto (which is what I currently use it for LOL). Outside of that, this project is living proof that after upskilling my frontend skills, I went back and improved one of my projects, making it more stylized and designed with my own flair, abandoning the boilerplated bootstrap and raw HTML look for something more sleek, like React, Material UI, and framer-motion. 
